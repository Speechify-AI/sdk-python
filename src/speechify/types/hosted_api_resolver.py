...
class HostedApiResolver(UniversalBaseModel):
    """
    ...
    write_mode: typing.Optional[HostedApiResolverWriteMode] = pydantic.Field(default=None)
    """
    ...
    where: typing.Optional[typing.List[HostedApiResolverWhereItem]] = None
    order_by: typing.Optional[HostedApiResolverOrderBy] = None
    ...
    metrics: typing.Optional[typing.List[StoreAggregateMetric]] = pydantic.Field(default=None)
    """
    ...
    file_root: typing.Optional[str] = pydantic.Field(default=None)
    """
    ...
    file_index: typing.Optional[str] = pydantic.Field(default=None)
    """
    ...
    wait_seconds: typing.Optional[int] = pydantic.Field(default=None)
    """
    ...
    allow_write: typing.Optional[bool] = pydantic.Field(default=None)
    """
